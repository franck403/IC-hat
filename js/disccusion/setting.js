...
class MyCustomElement extends HTMLElement {
    ...
    connectedCallback() {
        var div = `
        <style>@media screen and (min-width:900px){.context-menu{background-color:#fff;color:#1f194c;max-width:200px;z-index:10;padding:4px;font-size:20px;display:flex;flex-wrap:wrap;position:fixed;border-radius:5px;border:1px solid #00000030;visibility:hidden}.context-menu span{color:#000;padding:10px;width:100%}.context-menu span i{margin-right:20px;color:#000}.context-menu span i:hover{background-color:rgba(44,141,247,.2);color:#000}.item{color:#000}.context-menu span:hover{color:#000;background-color:rgba(44,141,247,.2);cursor:pointer}}@media screen and (max-width:900px){.context-menu{background-color:#fff;color:#1f194c;max-width:200px;z-index:10;padding:4px;font-size:20px;display:flex;flex-wrap:wrap;position:fixed;border-radius:5px;border:1px solid #00000030;visibility:hidden}.context-menu span{color:#000;padding:10px;width:100%}.context-menu span i{margin-right:20px;color:#000}.context-menu span i:hover{background-color:rgba(44,141,247,.2);color:#000}.item{color:#000}.context-menu span:hover{color:#000;background-color:rgba(44,141,247,.2);cursor:pointer}}</style>
