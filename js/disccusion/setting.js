...
function displayName() {
    window.changeDisplayNameIntern(localStorage.getItem('lastChat'))
}

function createInviteDiscusion() {
    window.createInviteDiscusion(localStorage.getItem('lastChat'))
}